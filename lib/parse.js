...
module.exports.getStringArray = function (search, data) {
  ...
  for (i = 0; i < length; i++)
  {
    ...
    var logEntry = data.toString('utf8', bytePtr, bytePtr + valueLength - 1); // length includes null termination of string
    values.push(logEntry.replace(/\0[\s\S]*$/g,'')); // Cf. https://github.com/timhuijgen/ark-files/blob/master/util.js#L100
    bytePtr += valueLength;
  }
